...
//   const uploadvideofile = () => {
//     console.log('Video file before upload:', videofile);  
...
//     } else if (videofile.size > 1000000) { 
//       alert('Please attach a video file smaller than 1MB');
//     } else {
//       const filedata = new FormData();
//       filedata.append('file', videofile);
//       filedata.append('title', title);
...
//       console.log('Uploading video file:', videofile);  // Debug log before dispatching
//       dispatch(uploadvideo({ filedata: filedata, fileoption: fileoption }));
//     }
//   };
